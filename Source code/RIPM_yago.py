...
databaseQuery = "insert into results_first_method_optimized_new_yago (target_entity_code, target_entity_type, property, class, class_rank, Gini, proportion, objects_number, facts_number, Gini_times_proportion, Gini_Times_proportion_times_Rank, gini_calculation_method, time_to_get_result, sampling, queries_number, percentage, queries_number_per_record) VALUES "
timePerOccupation = 0
time_per_thread = []
...
def process_classes(property, Class, ReferenceRelation, currentEntity, sparql, rank, totalObjectsNumberPerEntity, entityTargetType, gini_calculation_method):
    ...
    try:
        ...
        with lock2:
            time_per_thread.append(elapsed_time_seconds)
        traceback.print_exc()
        with open("ErrorsYago.txt", "a", encoding="utf-8") as file:
...
if __name__ == '__main__':
    ...
    sparql = SPARQLWrapper("https://yago-knowledge.org/sparql/query", agent='Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.102 Safari/537.36')
    #DataBase declarations###############################################################################


    for entityTargetType in ["classes"]:
        for gini_calculation_method in ["model","data"]:
            ...
            databaseQuery = """ SELECT distinct target_entity_code
                                FROM results_first_method_optimized_new_yago
            ...
            if entityTargetType == "occupations":
                ...
                list_of_entities = ["http://yago-knowledge.org/resource/Politician", "http://yago-knowledge.org/resource/Association_football_player", "http://yago-knowledge.org/resource/Writer", "http://yago-knowledge.org/resource/University_Teacher_Q1622272", "http://yago-knowledge.org/resource/Journalist", "http://yago-knowledge.org/resource/Lawyer", "http://yago-knowledge.org/resource/Painter", "http://yago-knowledge.org/resource/Actor", "http://yago-knowledge.org/resource/Film_actor", "http://yago-knowledge.org/resource/Singer", "http://yago-knowledge.org/resource/Cricketer", "http://yago-knowledge.org/resource/Television_actor", "http://yago-knowledge.org/resource/Composer", "http://yago-knowledge.org/resource/Baseball_player", "http://yago-knowledge.org/resource/Businessperson", "http://yago-knowledge.org/resource/Screenwriter", "http://yago-knowledge.org/resource/Film_director", "http://yago-knowledge.org/resource/Judge", "http://yago-knowledge.org/resource/Ice_hockey_player", "http://yago-knowledge.org/resource/Historian", "http://yago-knowledge.org/resource/Stage_actor", "http://yago-knowledge.org/resource/Film_producer", "http://yago-knowledge.org/resource/Officer__u0028_armed_forces_u0029_", "http://yago-knowledge.org/resource/Songwriter", "http://yago-knowledge.org/resource/Engineer", "http://yago-knowledge.org/resource/Architect", "http://yago-knowledge.org/resource/Swimmer", "http://yago-knowledge.org/resource/Translator", "http://yago-knowledge.org/resource/Physician", "http://yago-knowledge.org/resource/Economist", "http://yago-knowledge.org/resource/Photographer", "http://yago-knowledge.org/resource/Mathematician", "http://yago-knowledge.org/resource/Sculptor", "http://yago-knowledge.org/resource/Boxer", "http://yago-knowledge.org/resource/Teacher", "http://yago-knowledge.org/resource/Philosopher", "http://yago-knowledge.org/resource/Tennis_player", "http://yago-knowledge.org/resource/Musician", "http://yago-knowledge.org/resource/Record_producer", "http://yago-knowledge.org/resource/Pianist", "http://yago-knowledge.org/resource/Rower", "http://yago-knowledge.org/resource/Physicist", "http://yago-knowledge.org/resource/Television_presenter", "http://yago-knowledge.org/resource/Television_producer", "http://yago-knowledge.org/resource/Guitarist", "http://yago-knowledge.org/resource/Entrepreneur", "http://yago-knowledge.org/resource/Researcher", "http://yago-knowledge.org/resource/Voice_actor", "http://yago-knowledge.org/resource/Artist", "http://yago-knowledge.org/resource/Chemist",
                                    "http://yago-knowledge.org/resource/Opera_singer","http://yago-knowledge.org/resource/Handball_player", "http://yago-knowledge.org/resource/Coach__u0028_basketball_u0029_", "http://yago-knowledge.org/resource/Illustrator", "http://yago-knowledge.org/resource/Music_Teacher_Q16145150", "http://yago-knowledge.org/resource/Editor", "http://yago-knowledge.org/resource/Volleyball_player", "http://yago-knowledge.org/resource/Computer_scientist", "http://yago-knowledge.org/resource/Professor", "http://yago-knowledge.org/resource/Psychologist",  "http://yago-knowledge.org/resource/Banker_Q806798", "http://yago-knowledge.org/resource/Explorer_Q11900058", "http://yago-knowledge.org/resource/Chess_player", "http://yago-knowledge.org/resource/Scientist", "http://yago-knowledge.org/resource/Sport_shooter", "http://yago-knowledge.org/resource/Golfer", "http://yago-knowledge.org/resource/Inventor", "http://yago-knowledge.org/resource/Comedian", "http://yago-knowledge.org/resource/Sociologist", "http://yago-knowledge.org/resource/Farmer", "http://yago-knowledge.org/resource/Dancer", "http://yago-knowledge.org/resource/Rapper", "http://yago-knowledge.org/resource/Military_Leader_Q1402561", "http://yago-knowledge.org/resource/Political_scientist", "http://yago-knowledge.org/resource/Surgeon", "http://yago-knowledge.org/resource/Jurist", "http://yago-knowledge.org/resource/Publisher_Q2516866", "http://yago-knowledge.org/resource/Professional_Wrestler_Q13474373", "http://yago-knowledge.org/resource/Badminton_player", "http://yago-knowledge.org/resource/Comics_artist", "http://yago-knowledge.org/resource/Film_editor", "http://yago-knowledge.org/resource/Choreographer", "http://yago-knowledge.org/resource/Soldier", "http://yago-knowledge.org/resource/Author", "http://yago-knowledge.org/resource/Printmaker", "http://yago-knowledge.org/resource/Television_director", "http://yago-knowledge.org/resource/Civil_engineer", "http://yago-knowledge.org/resource/Police_officer", "http://yago-knowledge.org/resource/Designer", "http://yago-knowledge.org/resource/Racing_driver", "http://yago-knowledge.org/resource/Biologist", "http://yago-knowledge.org/resource/Geologist", "http://yago-knowledge.org/resource/Biochemist", "http://yago-knowledge.org/resource/Nurse", "http://yago-knowledge.org/resource/Curator", "http://yago-knowledge.org/resource/Naturalist_Q18805", "http://yago-knowledge.org/resource/Publisher", "http://yago-knowledge.org/resource/Psychiatrist", "http://yago-knowledge.org/resource/Statistician", "http://yago-knowledge.org/resource/Animator"]
                ...
                try:
                    ...
                    if gini_calculation_method == "model":
                        ...
                        for result in results["results"]["bindings"]:
                            ...
                            sparqlInstance = SPARQLWrapper("https://yago-knowledge.org/sparql/query",
